    ...
    public void run() {
        ...
        for (int i = 0; i < LoopSize; i++) {
            ...
            try {
                ...
                if (writeVec) {
                    writeVecor(new File(modelFile + "/vector/" + source + "_alphaBiasLevel_" + alphaLevel + "_vectortrain_" + flagNum + "->" + limitRandom * 100 + "%" + ".txt"),
                            new File(modelFile + "/vector/" + source + "_alphaBiasLevel_" + alphaLevel + "_vectortest_" + flagNum + "->" + limitRandom * 100 + "%" + ".txt"),
                            new File(modelFile + "/vector/" + source + "_alphaBiasLevel_" + alphaLevel + "_vectorall_" + flagNum + "->" + limitRandom * 100 + "%" + ".txt"),
                            new File(modelFile + "/vector/" + source + "_alphaBiasLevel_" + alphaLevel + "_trainlabel_" + flagNum + "->" + limitRandom * 100 + "%" + ".txt"));
                    //writeVec=false;
                }
